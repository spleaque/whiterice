...
yay -S --needed --noconfirm zen-browser-bin localsend-bin mangowm foot fuzzel helix swaybg mako rofi starship waybar libnotify ttf-jetbrains-mono-nerd noto-fonts-cjk nautilus grim slurp
